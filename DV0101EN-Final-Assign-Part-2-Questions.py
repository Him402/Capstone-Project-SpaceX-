...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard", style={'textAlign':'center', 'color':'#503D36', 'font_size':24 }),#Include style for title
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            style={'textAlign':'centre','width':'80%','padding':'3px'}
        )
    ]),
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, x = 'Year', y = 'Automobile_Sales',tit))
